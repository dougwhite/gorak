...
- [x] DBA-reviewed revision extension SQL export and generation-bound internal samples implemented; isolated OpenROAD capture, rollback and repeat-install rejection passed. Extension validation and diagnostic/backend integration pending. See [extension](../research/revision-extension.md).
