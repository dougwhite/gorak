...
- [x] Reader timeout reproduced as documented serializable-ROW/MVCC incompatibility. Table-specific MVCC/shared passed live SQL matrix and actual CLI writer/reader checks; see [reader acceptance](../research/counter-reader-acceptance.md). Manual Workbench MVCC combination pending.
